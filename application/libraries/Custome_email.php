...
class Custome_email {
    ...
    public function customSendEmail($from, $to, $subject, $template)
    {
         $this->CI->email->set_newline("\r\n");
   ...
   **/
   ...
   {
         $data= $this->CI->db->get_where('email_template',["id" => $messageId ,'is_active' => 1 ])->row();

        $this->emailBody =$data->email_template_description;
		$this->subject = $data->email_template_subject;
        $this->getEmailkey();
        return $this;
   }
