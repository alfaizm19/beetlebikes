			...
			<div class="col-md-12">
				<div class="row mt-3">
					<div class="col-md-4 mx-auto mb-4">
						<div class="separator text-dark">Login to MMTC-PAMP</div>
					</div>
						...
						<div class="col-md-4 mx-auto">
							<div class="row mt-3">
								<div class="col-12 text-center">
									...
									<button type="submit" id="btnLogin" class="btn btn-login btn-block px-3 rounded-btn">Login to continue</button>
								</div>
