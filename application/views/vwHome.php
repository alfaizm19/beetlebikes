...
<div class="slide-mobile-overlay swiper-wrapper">
  ...
  ?>
    ...
    ?>
      ...
      <div class="slide-mobile-overlay swiper-slide" >
        <img src="<?php echo base_url($banner->banner_image) ?>" class="img-responsive" />
...
<section class="offset-top-45 section_banners">
  <div class="container">
      <h3>Enter the world of MMTC-PAMP | #PurestGold</h3>
    ...
    <div class="row full_w_row">
      ...
      <div class="col-sm-6 banner_big_50 mb-2 cursorPointer" onclick="window.location='<?php echo base_url('gold') ?>'">
        	...
        	<img src="<? echo HTTP_ASSETS_PATH_CLIENT; ?>/images/img1.jpg" class="img-fluid" style="height:648px" />
      ...
      <div class="col-sm-6 banner_big_50 mb-2 cursorPointer">
            <div class="row ">
                <div class="col-12 mb-3">
                    <!-- <img src="<? echo HTTP_ASSETS_PATH_CLIENT; ?>/images/img2.jpg" class="img-fluid"/> -->
                    <video width="100%" height="320" autoplay muted loop>
                      <source src="<? echo HTTP_ASSETS_PATH_CLIENT; ?>/videos/videoplayback.mp4" type="video/mp4">
                    Your browser does not support the video tag.
                    </video>
                </div>
                <div class="col-12" onclick="window.location='<?php echo base_url('collectible') ?>'">
...
<section class="section-top-60 mb-4 advantage_sec">
  <div class="container">
    <h3>Invest in best-in-class precious metals</h3>
    <hr class="divider divider-base divider-bold">
    <div class="row offset-top-30">
        <div class="col-lg-3 col-md-6 text-center mb-3">
            <img src="<? echo HTTP_ASSETS_PATH_CLIENT; ?>/images/MMTC_icons_01.png" class="img-responsive"/>
            <p>Trust of India’s only LBMA accredited refinery.</p>
        </div>
        <div class="col-lg-3 col-md-6 text-center mb-3">
            <img src="<? echo HTTP_ASSETS_PATH_CLIENT; ?>/images/MMTC_icons_02.png" class="img-responsive"/>
            <p>Prices linked to international markets.</p>
        </div>
        <div class="col-lg-3 col-md-6 text-center mb-3">
            <img src="<? echo HTTP_ASSETS_PATH_CLIENT; ?>/images/MMTC_icons_03.png" class="img-responsive"/>
            <p>Buyback guarantee at MMTC-PAMP exclusive outlets.</p>
        </div>
        <div class="col-lg-3 col-md-6 text-center mb-3">
            <img src="<? echo HTTP_ASSETS_PATH_CLIENT; ?>/images/MMTC_icons_04.png" class="img-responsive"/>
            <p>Fast & secure delivery with specialized courier partners</p>
        </div>
    </div>
  </div>
</section>  
...
<?php 
  $blogs = $this->Master_model->get_blogs();

  if(!empty($blogs)):
?>
<section class="section-top-60">
        <div class="container">
          <h3>MMTC-PAMP Gold Blog</h3>
          <hr class="divider divider-base divider-bold">
          <div class="owl-mobile-dots owl-nav-md owl-nav-position-top owl-carousel offset-top-30" data-mouse-drag="false" data-autoplay="4000" data-lg-items="3" data-md-items="2" data-sm-items="2" data-margin="30" data-dots="true" data-nav="true">
            ...
            <div class="blog-post blog-post-grid">
              <div class="blog-post-media"><a target="_blank" href="<?php echo $blog->link ?>"><img class="img-responsive" width="1170" height="854" alt="" src="<?php echo $blog->image ?>">
                  <div class="blog-post-caption">
                    <div class="blog-post-meta-date"><span class='blog-post-meta-date-big reveal-block'><?php echo date('d', strtotime($blog->date)); ?></span> <?php echo date('M', strtotime($blog->date)); ?></div>
                  </div></a></div>
              <div class="blog-post-meta">
                <h5 class="blog-post-meta-title"><a class="text-base" href="<?php echo $blog->link ?>"><?php echo $blog->title ?></a></h5>
                <p><i>Posted by</i> <a href='<?php echo $blog->link ?>'>MMTC-PAMP</a></p>
              </div>
              <p><?php echo $blog->description ?></p>
              <div><a class="btn btn-link" href="<?php echo $blog->link ?>"><span class="btn-text">read more</span></a></div>
            </div>
            <?php endforeach ?>
