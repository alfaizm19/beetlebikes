           ...
           <? foreach ($projects as $key => $projects_val): ?>  
            <section class="col-lg-4">
              <aside class="industries-list">
                <figure class="figure-custom"><img src="<? echo base_url($projects_val['project_image_thumb']); ?>" alt="<? echo $projects_val['project_title']; ?>"><div class="border"><span class="zoomicon" data-toggle="modal" data-target="#productid" data-id="<?=$key?>"></span></div></figure>
