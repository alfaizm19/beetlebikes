<div class="m-subheader ">
  <div class="d-flex align-items-center">
    ...
    <a href="<? echo base_url('admin/visa-options/create'); ?>" class="btn btn-success m-btn m-btn--icon text-capitalize"> <span> <i class="fa fa-plus-circle"></i><span></span>Add Visa Option</span> </a></div>
</div>
<div class="col-sm-12">
    ...
    <table id="gridTable" class="table table-striped m-table ">
      <thead>
        <tr class="p-0 ">
          ...
          <th width="10%" class="py-3">Visa Type</th>
          <th width="15%" class="py-3">Visa</th>
          <th width="25%" class="text-center py-3">Visa Option Name</th>
          <th width="10%" class="text-center py-3">Normal</th>
          <th width="10%" class="text-center py-3">Express</th>
