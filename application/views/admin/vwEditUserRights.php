            ...
            <div class="m-portlet__body pb-2">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input type="name" class="form-control input-lg m-input" id="name" name="name" value="<?php echo $user->username ?>" data-msg-required="Please enter name.">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input type="email" class="form-control input-lg m-input" id="email" name="email" value="<?php echo $user->email ?>" data-msg-required="Please enter email.">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <select class="form-control" name="role" id="role">
                            ...
                            <option <? echo ($user->role == 'super_admin'? 'selected':'') ?> value="super_admin">Super Admin</option>
                            <option <? echo ($user->role == 'admin'? 'selected':'') ?> value="admin">Admin</option>
                            <option <? echo ($user->role == 'operations'? 'selected':'') ?> value="operations">Operations</option>
                            <option <? echo ($user->role == 'catalog'? 'selected':'') ?> value="catalog">Catalog</option>
                        </select>
                ...
                <div class="form-group m-form__group row">
                  ...
                  <div class="col-lg-8 col-md-9 col-sm-12">
                    ...
                    <? if ($user->user_image != ""): ?>
                        <div class="w-25 mt-2">
                            <img class="w-100" src="<? echo base_url($user->user_image); ?>">
                        </div>
                    <? endif; ?>
                    ...
                    <div class="m-form__actions m-form__actions py-0 ">
                        <div class="row">
                            <div class="col-lg-9 ml-lg-auto">
                                ...
                                <a  class="btn btn-secondary" href="<?php echo base_url('admin/user-rights'); ?>"><i class="fa fa-times"></i> Cancel </a>
                            </div>
                        </div>
                    </div>
                </div>
