    ...
    <div class="col-md-4">
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <a id="exportBtn" href="<?php echo base_url('admin/wallet/createxls'.$buildQuery) ?>" class="btn btn-primary"><i class="fa fa-file-excel-o"></i> Export Data</a>
                </div>
            </div>
    </div>
		<!-- <div class="col-md-3">
		...
		<div class="col-md-8 btns">
            ...
            <a class="btn btn-warning" href="<?php echo base_url('admin/wallet') ?>" style="color: white">Reset</a>
