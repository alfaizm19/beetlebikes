<div class="m-subheader ">
    <div class="d-flex align-items-center">
        ...
        <a href="<?php echo base_url('admin/career/create'); ?>" class="btn btn-success m-btn m-btn--icon text-capitalize"> <span> <i class="fa fa-plus-circle"></i><span></span>Add Career</span> </a></div>
</div>
<div class="col-sm-12">
<? if(DISPLAY_ORDER): ?>
                    ...
                    <table id="gridTable" class="table table-striped m-table ">
                        <thead>
                            <tr class="p-0 ">
                                ...
                                <th width="58%" class="py-3">Position</th>
                                <? if(DISPLAY_ORDER): ?>
...
<input type="hidden" name="message" value="Career has been updated successfully.">
<input type="hidden" name="data_table" value="career">
