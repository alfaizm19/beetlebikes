<div class="m-subheader ">
    <div class="d-flex align-items-center">
        ...
        <a href="<? echo base_url('admin/brand/create'); ?>" class="btn btn-success m-btn m-btn--icon text-capitalize"> <span> <i class="fa fa-plus-circle"></i><span></span>Add Brand</span> </a></div>
</div>
<div class="col-sm-12">
                    ...
                    <table id="gridTable" class="table table-striped m-table ">
                        <thead>
                            <tr class="p-0 ">
                                ...
                                <th width="22%" class="py-3">Name</th>
                                <th width="18%" class="text-center py-3">Logo</th>
                                <th width="18%" class="text-center py-3">Roll Over Logo</th>
                                <?php if(DISPLAY_ORDER): ?>
...
<input type="hidden" name="message" value="Brand has been updated successfully.">
<input type="hidden" name="data_table" value="brand">
