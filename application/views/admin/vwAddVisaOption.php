        ...
        <form class="m-form m-form--fit m-form--label-align-right" action="<? echo current_url(); ?>" method="post" enctype="multipart/form-data" name="user_form" id="user_form" novalidate="novalidate">
            <div class="m-portlet__body pb-2">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <select name="visaType" class="form-control " id="visaType" data-placeholder="Select visa type" required data-msg-required="Please select visa type." data-allow-clear="true" >
                            ...
                            ?>
                                <option value="<?php echo $visaType->type ?>"><?php echo $visaType->type ?></option>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input type="text" class="form-control input-lg m-input" value="" name="visaOptionName" id="visaOptionName" required data-msg-required="Please enter blog title.">
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input type="checkbox" class="form-control input-lg m-input" value="normal" required name="normal" id="normal" data-msg-required="Please select processing type."> 
                ...
                <div class="normalDiv form-group m-form__group row" style="display:none">
                    ...
                    <div class="col-lg-2 col-md-9 col-sm-12">
                        <input type="text" required class="form-control input-lg m-input" value="<? echo get_input('meta_title'); ?>" data-msg-required="Please enter price." name="normalAED" id="normalAED">
                    </div>
                </div>
                ...
                <div class="normalDiv form-group m-form__group row" style="display:none">
                    ...
                    <div class="col-lg-2 col-md-9 col-sm-12">
                        <input type="text" required class="form-control input-lg m-input" value="<? echo get_input('meta_title'); ?>" data-msg-required="Please enter price." name="normalUSD" id="normalUSD">
                    </div>
                </div>
                ...
                <div class="normalDiv form-group m-form__group row" style="display:none">
                    ...
                    <div class="col-lg-2 col-md-9 col-sm-12">
                        <input type="text" required class="form-control input-lg m-input" value="<? echo get_input('meta_title'); ?>" data-msg-required="Please enter discount" name="normalDiscount" id="normalDiscount">
                    </div>
                </div>
                ...
                <div class="normalDiv form-group m-form__group row" style="display:none">
                    ...
                    <div class="col-lg-2 col-md-9 col-sm-12">
                        <input type="text" required class="form-control input-lg m-input" value="<? echo get_input('meta_title'); ?>" data-msg-required="Please enter processing duration" name="normalDuration" id="normalDuration">
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input type="checkbox" class="form-control input-lg m-input" value="express" name="express" id="express" data-msg-required="Please select processing type."> 
                ...
                <div class="expressDiv form-group m-form__group row" style="display:none">
                    ...
                    <div class="col-lg-2 col-md-9 col-sm-12">
                        <input type="text" class="form-control input-lg m-input" value="<? echo get_input('meta_title'); ?>" data-msg-required="Please enter price." name="expressAED" id="expressAED">
                    </div>
                </div>
                ...
                <div class="expressDiv form-group m-form__group row" style="display:none">
                    ...
                    <div class="col-lg-2 col-md-9 col-sm-12">
                        <input type="text" class="form-control input-lg m-input" value="<? echo get_input('meta_title'); ?>" data-msg-required="Please enter price." name="expressUSD" id="expressUSD">
                    </div>
                </div>
                ...
                <div class="expressDiv form-group m-form__group row" style="display:none">
                    ...
                    <div class="col-lg-2 col-md-9 col-sm-12">
                        <input type="text" class="form-control input-lg m-input" value="<? echo get_input('meta_title'); ?>" data-msg-required="Please enter discount" name="expressDiscount" id="expressDiscount">
                    </div>
                </div>
                ...
                <div class="expressDiv form-group m-form__group row" style="display:none">
                    ...
                    <div class="col-lg-2 col-md-9 col-sm-12">
                        <input type="text" class="form-control input-lg m-input" value="<? echo get_input('meta_title'); ?>" data-msg-required="Please enter processing duration" name="expressDuration" id="expressDuration">
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-2 col-md-9 col-sm-12">
                        <input type="text" class="form-control input-lg m-input" value="" required data-msg-required="Please enter valid to enter" name="validToEnter" id="validToEnter">
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-2 col-md-9 col-sm-12">
                        <input type="text" class="form-control input-lg m-input" value="<? echo get_input('meta_title'); ?>" required data-msg-required="Please enter valid to stay" name="validToStay" id="validToStay">
                    </div>
                </div>
