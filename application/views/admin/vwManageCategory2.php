<div class="m-subheader ">
  ...
  <a href="<? echo base_url('admin/category-level-2/create'); ?>" class="btn btn-success m-btn m-btn--icon text-capitalize"> <span> <i class="fa fa-plus-circle"></i><span></span>Add Category</span> </a></div>
</div>
<div class="col-sm-12">
                        ...
                        <thead>
                            <tr class="p-0 ">
                                <th width="8%" data-orderable="false" class="text-secondary py-3" > <label class="m-checkbox m-checkbox--single p-0 m-checkbox--all m-checkbox--solid m-checkbox--brand">
                                    ...
                                    <th width="25%" class="py-3">Category</th>
                                    <th width="25%" class="py-3">Parent</th>
                                    <?php if(DISPLAY_ORDER): ?>
