<div class="m-subheader ">
    <div class="d-flex align-items-center">
        ...
        <a href="<? echo base_url('admin/news_media/create/' . $this->uri->segment(4) . ''); ?>" class="btn btn-success m-btn m-btn--icon text-capitalize"> <span> <i class="fa fa-plus-circle"></i><span></span>Add Image/Videos </span> </a>
      &nbsp;    &nbsp;  <a href="<? echo base_url('admin/news/'); ?>" class="btn btn-success manageproject m-btn m-btn--icon text-capitalize"> <span> Manage News</span> </a>
    </div>
</div>
