        ...
        <form class="m-form m-form--fit m-form--label-align-right" action="<? echo current_url(); ?>" method="post" enctype="multipart/form-data" name="user_form" id="user_form" novalidate="novalidate">
            <div class="m-portlet__body pb-2">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input type="text" class="form-control input-lg m-input" value="" name="visaName" id="visaName" required data-msg-required="Please enter blog title.">
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12">
                        <textarea name="documents" id="documents" required data-msg-ckrequired="Please enter documents." class="form-control ckerequired description input-lg m-input" rows="4"></textarea>
                        <div class="has-error"></div>
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12">
                        <textarea name="howToApply" id="howToApply" required data-msg-ckrequired="Please enter how to apply." class="form-control ckerequired description input-lg m-input" rows="4"></textarea>
                        <div class="has-error"></div>
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12">
                        <div class="cropoutterwrap">
                            <input type="file" required class="form-control validImage" name="visaImage" id="visaImage" data-image-crop="1"  
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12">
                        <div class="cropoutterwrap">
                            <input type="file" required class="form-control validImage" name="visaBanner" id="visaBanner" data-image-crop="1"  
