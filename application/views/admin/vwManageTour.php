<div class="m-subheader ">
  <div class="d-flex align-items-center">
    ...
    <a href="<? echo base_url('admin/tours/create'); ?>" class="btn btn-success m-btn m-btn--icon text-capitalize"> <span> <i class="fa fa-plus-circle"></i><span></span>Add Tours</span> </a></div>
</div>
<div class="col-sm-12">
    ...
    <table id="gridTable" class="table table-striped m-table ">
      <thead>
        <tr class="p-0 ">
          ...
          <th width="25%" class="py-3">Tours</th>
          <th width="25%" class="text-center py-3">Review Link</th>
          <th width="10%" class="text-center py-3" data-orderable="false">Reviews</th>
          <th width="5%" class="text-center py-3" data-orderable="false">Gallery</th>
          <th width="5%" class="text-center py-3" data-orderable="false">FAQ's</th>
...
<input type="hidden" name="message" value="Tour has been updated successfully.">
<input type="hidden" name="data_table" value="tour">
