<div class="m-subheader ">
  <div class="d-flex align-items-center">
    ...
    <a href="<?php echo base_url('admin/press_image/create/'.$this->uri->segment(4).''); ?>" class="btn btn-success m-btn m-btn--icon text-capitalize manageproject"> <span> <i class="fa fa-plus-circle"></i><span></span>Add Press Image </span> </a>
    <a href="<?php echo base_url('admin/press/'); ?>" class="btn btn-success  m-btn m-btn--icon text-capitalize"> <span> Manage Press</span> </a>
  </div>
</div>
