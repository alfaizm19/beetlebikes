<div class="m-subheader ">
    <div class="d-flex align-items-center">
        ...
        <a href="<? echo base_url('admin/staycations'); ?>" class="btn btn-success m-btn m-btn--icon text-capitalize"> </span>Staycations</span> </a></div>
</div>
<div class="col-sm-12">
        ...
        <? if (DISPLAY_ORDER): ?>
                    ...
                    <table id="gridTable" class="table table-striped m-table ">
                        <thead>
                            <tr class="p-0 ">
								...
								<th width="20%" class="py-3">Rating</th>
                                <? if (DISPLAY_ORDER): ?>
                                    <th class="text-center py-3" width="20%">Display order</th>
                                <? endif; ?>
            ...
            <? if (DISPLAY_ORDER): ?>
                <div class="m-portlet__foot m-portlet__foot--fit border-top-1 border-secondary">
                    ...
                    <input type="hidden" name="data_table" value="staycations_reviews">
