<div class="m-subheader ">
  <div class="d-flex align-items-center">
    ...
    <a href="<?php echo base_url('admin/product_image/create/'.$this->uri->segment(4).''); ?>" class="btn btn-success m-btn m-btn--icon text-capitalize manageproject"> <span> <i class="fa fa-plus-circle"></i><span></span>Add Product Image </span> </a>
    ...
    <table id="gridTable" class="table table-striped m-table ">
      <thead>
        <tr class="p-0 ">
          ...
          <th width="70%" class="text-center py-3">Image/Video</th>
