...
<div class="m-portlet m-portlet--primary m-portlet--head-solid-bg m-portlet--head-sm" data-portlet="true" id="m_portlet_tools_2">
  ...
  <form class="m-form m-form--fit m-form--label-align-right" action="<? echo current_url(); ?>" method="post" enctype="multipart/form-data" name="testimonial_form" id="testimonial_form" novalidate="novalidate">
    <div class="m-portlet__body pb-2">
      ...
      <div class="form-group m-form__group row">
        ...
        <div class="col-lg-4 col-md-9 col-sm-12">
          <input type="name" class="form-control input-lg m-input" id="title" name="title"  value="<?php echo $review->title ?>" required data-msg-required="Please enter title.">
        </div>
      </div>
      ...
      <div class="form-group m-form__group row">
        ...
        <div class="col-lg-6 col-md-9 col-sm-12">
          <textarea required name="testimonial" id="testimonial" data-msg-required="Please enter testimonial" class="form-control   input-lg m-input" rows="8"><? echo get_input('testimonial'); ?><?php echo $review->testimonial ?></textarea>
    ...
    <div class="form-group m-form__group row">
        ...
        <div class="col-lg-4 col-md-9 col-sm-12">
          <input type="name" class="form-control input-lg m-input" id="name" name="name"  value="<?php echo $review->name ?>" required data-msg-required="Please enter name.">
        </div>
      </div>
    <div class="form-group m-form__group row">
        <label class="col-form-label col-lg-3 col-sm-12" for="name">Company Name/Designation<span class="text-danger">*</span></label>
        <div class="col-lg-4 col-md-9 col-sm-12">
          <input type="name" class="form-control input-lg m-input" id="designation" name="designation"  value="<?php echo $review->company ?>" required data-msg-required="Please enter designation.">
        </div>
      </div>
    ...
    <? echo CLIENT_SIZE; ?> </label>
        <div class="col-lg-9 col-md-12 col-sm-12">
          ...
          <? if ($review->profile_picture != ""): ?>
              <div class="w-25 mt-2">
                  <img class="w-100" src="<? echo base_url($review->profile_picture); ?>">
              </div>
          <? endif; ?>
        </div>
      </div>
      ...
      <div class="form-group m-form__group row">
          ...
          <div class="col-lg-4 col-md-9 col-sm-12">
              <select name="rating" class="form-control " id="rating" data-placeholder="Select rating" required data-msg-required="Please select rating." data-allow-clear="true">
                  ...
                  <option <?php echo $review->rating == '2'? 'selected':''; ?> value="2">2 Stars - Poor</option>
      ...
      <div class="form-group m-form__group row">
        ...
        <div class="col-sm-2">
          <input type="number" maxlength="2" minlength="1" pattern="[0-9]+" class="form-control w-50 m-input" id="display_order" name="display_order" value="<?php echo $review->display_order ?>">
        </div>
      </div>
