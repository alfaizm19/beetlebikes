<div class="m-subheader ">
  <div class="d-flex align-items-center">
    ...
    <a href="<?php echo base_url('admin/product_showcase/create/'.$this->uri->segment(4).''); ?>" class="btn btn-success m-btn m-btn--icon text-capitalize manageproject"> <span> <i class="fa fa-plus-circle"></i><span></span>Add Product Showcase </span> </a>
    <a href="<?php echo base_url('admin/product/'); ?>" class="btn btn-success  m-btn m-btn--icon text-capitalize"> <span> Manage Products</span> </a>
  </div>
</div>
    ...
    <table id="gridTable" class="table table-striped m-table ">
      <thead>
        <tr class="p-0 ">
          ...
          <th width="15%" class="text-center py-3">Title</th>
          <th width="20%" class="text-center py-3">Image</th>
