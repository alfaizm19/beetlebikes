  ...
  <div class="m-portlet__body pb-2">
    ...
    <div class="form-group m-form__group row">
      ...
      <div class="form-group m-form__group row Image">
        <label class="col-form-label col-lg-3 col-sm-12" for="image_path"> Image (1920px W * 350px H)  </label>
        <div class="col-lg-9 col-md-12 col-sm-12">
            <div class="cropoutterwrap">
                <input type="file"  class="form-control validImage" name="image_path" id="image_path" data-image-crop="0" data-image-height="350" data-image-width="1920" data-caption="Image" data-image-path ="category/" data-msg-required="Please upload image">
            </div>
      ...
      <div class="form-group m-form__group row Image">
        <label class="col-form-label col-lg-3 col-sm-12" for="category_image"> Category Image (644px W * 350px H)
        ...
        <div class="col-lg-9 col-md-12 col-sm-12">
            <div class="cropoutterwrap">
                <input type="file" <?php echo empty($category->category_image)? 'required':''; ?> class="form-control validImage" name="category_image" id="category_image" data-image-crop="1" data-image-height="350" data-image-width="644" data-caption="Image" data-image-path ="category/image/" data-msg-required="Please upload image">
            </div>
