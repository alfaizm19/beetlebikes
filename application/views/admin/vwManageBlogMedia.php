<div class="m-subheader ">
    <div class="d-flex align-items-center">
        ...
        <a href="<? echo base_url('admin/blog_media/create/' . $this->uri->segment(4) . ''); ?>" class="btn btn-success m-btn m-btn--icon text-capitalize"> <span> <i class="fa fa-plus-circle"></i><span></span>Add Image/Videos </span> </a>
      &nbsp;    &nbsp;  <a href="<? echo base_url('admin/blog/'); ?>" class="btn btn-success manageproject m-btn m-btn--icon text-capitalize"> <span> Manage Blogs</span> </a>
    </div>
</div>
                ...
                <table id="gridTable" class="table table-striped m-table ">
                    <thead>
                        <tr class="p-0 ">
                            ...
                            <th width="43%" class="py-3">Caption</th>
                            <th width="33%" class="text-center py-3">Image/Video</th>
