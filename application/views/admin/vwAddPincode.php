            ...
            <div class="m-portlet__body pb-2">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input min="1" minlength="6" maxlength="6" type="number" class="form-control input-lg m-input" id="pincode" name="pincode" value="<?php echo get_input('pincode'); ?>" required data-msg-required="Please enter pincode name.">
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input type="text" class="form-control input-lg m-input" id="state" name="state" value="<?php echo get_input('state'); ?>" required data-msg-required="Please enter state name.">
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input type="text" class="form-control input-lg m-input" id="city" name="city" value="<?php echo get_input('city'); ?>" required data-msg-required="Please enter city name.">
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input type="text" class="form-control input-lg m-input" id="delivery_days" name="delivery_days" value="<?php echo get_input('delivery_days'); ?>" required data-msg-required="Please enter delivery days.">
                    </div>
                </div>
