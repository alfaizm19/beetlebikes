<div class="m-subheader ">
    <div class="d-flex align-items-center">
        ...
        <a style="margin-right: 20px;" href="<?php echo base_url('admin/visa/'); ?>" class="btn btn-success m-btn text-capitalize m-btn--icon"></span>Visas</span> </a>
        <a href="<?php echo base_url('admin/faq/create/'.$visaId); ?>" class="btn btn-success m-btn m-btn--icon text-capitalize"> <span> <i class="fa fa-plus-circle"></i><span></span>Add FAQs</span> </a>
    </div>
</div>
<div class="col-sm-12">
