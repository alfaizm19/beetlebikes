<div class="m-subheader ">
  <div class="d-flex align-items-center">
    ...
    <a href="<? echo base_url('admin/freebee/create'); ?>" class="btn btn-success m-btn m-btn--icon text-capitalize"> <span> <i class="fa fa-plus-circle"></i><span></span>Add Freebee</span> </a></div>
</div>
<div class="col-sm-12">
...
<div class="m-portlet__body">
  <div class="m_datatable m-datatable m-datatable--default m-datatable--loaded">
    <table id="gridTable" class="table table-striped m-table ">
      <thead>
        <tr class="p-0 ">
          <th width="6%" data-orderable="false" class="text-secondary py-3" > <label class="m-checkbox m-checkbox--single p-0 m-checkbox--all m-checkbox--solid m-checkbox--brand">
          ...
          <th width="25%" class="py-3">Product</th>
          <th width="25%" class="text-center py-3">Freebee Product</th>
