<div class="m-subheader ">
  <div class="d-flex align-items-center">
    ...
    <a href="<? echo base_url('admin/project/create'); ?>" class="btn btn-success m-btn m-btn--icon text-capitalize"> <span> <i class="fa fa-plus-circle"></i><span></span>Add Project</span> </a></div>
</div>
<div class="col-sm-12">
...
<input type="hidden" name="message" value="Project has been updated successfully.">
<input type="hidden" name="data_table" value="project">
