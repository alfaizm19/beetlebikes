            ...
            <div class="m-portlet__body pb-2">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input type="text" class="form-control input-lg m-input" value="<?php echo $attribute->name ?>" name="attribute_name" id="attribute_name" required data-msg-required="Please enter attribute name.">
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input type="text" class="form-control input-lg m-input" value="<?php echo $attribute->slug ?>" name="slug" id="slug" required data-msg-required="Please enter attribute slug.">
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <div class="mt">
                            <label>
                                <input <?php echo $attribute->filter? 'checked':'' ?> type="checkbox" name="filter" id="filter" value="1">
                                <span></span>
                            </label>
                        </div>
                    </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <div class="mt">
                            <label>
                                <input <?php echo $attribute->search? 'checked':'' ?> type="checkbox" name="search" id="search" value="1">
                                <span></span>
                            </label>
                        </div>
                    </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <div class="mt">
                            <label>
                                <input <?php echo $attribute->multi? 'checked':'' ?> type="checkbox" name="multi" id="multi" value="1">
                                <span></span>
                            </label>
                        </div>
                    </div>
