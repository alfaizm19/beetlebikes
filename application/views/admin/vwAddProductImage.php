  ...
  <form class="m-form m-form--fit m-form--label-align-right" action="<?php echo current_url(); ?>" method="post" enctype="multipart/form-data" name="product_form" id="product_form" novalidate="novalidate">
    <div class="m-portlet__body pb-2">
      ...
      <div class="form-group m-form__group row Image">
        <label class="col-form-label col-lg-3 col-sm-12" for="product_image1"> Image   (800px W * 700px H)<?php //echo PRODUCT_IMAGES;?><span class="text-danger">*</span> </label> 
...
<div class="added_Image">
  <div class="form-group m-form__group row Image">
    <label class="col-form-label col-lg-3 col-sm-12" for="product_image${intIndex}"> Image  (800px W * 700px H)<?php //echo PRODUCT_IMAGES; ?><span class="text-danger">*</span> </label> 
    <div class="col-lg-9 col-md-12 col-sm-12">
      <div class="cropoutterwrap">
