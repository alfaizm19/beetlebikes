    ...
    <table id="gridTable" class="table table-striped m-table ">
      <thead>
        <tr class="p-0 ">
          ...
          <th width="17%" class="py-3">Name</th>          
          <th width="16%" class="py-3">Position Name</th>
          <th width="16%" class="py-3">Years of Experience</th>
          <th width="10%" class="py-3">Received Date</th>
