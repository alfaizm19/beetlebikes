<div class="m-subheader ">
    <div class="d-flex align-items-center">
        ...
        <!-- <a class="pull-right btn btn-primary btn-xs" href="<?php echo base_url('admin/payments/createxls') ?>"><i class="fa fa-file-excel-o"></i> Export Datas</a> -->
      </div>
</div>
    ...
    <div class="col-md-4">
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <a id="exportBtn" href="<?php echo base_url('admin/payments/createxls'.$buildQuery) ?>" class="btn btn-primary"><i class="fa fa-file-excel-o"></i> Export Data</a>
                </div>
            </div>
    </div>
		<!-- <div class="col-md-3">
		...
		<div class="col-md-8 btns">
            ...
            <a class="btn btn-warning" href="<?php echo base_url('admin/payments') ?>" style="color: white">Reset</a>
        ...
        <?php if (DISPLAY_ORDER): ?>
            ...
            <div class="m-portlet__body">
                <!-- <p style="margin-left: 20px">Note: Use these keywords while searching
                    <br>
                1. <b>nb</b> for "Net banking"<br>
                2. <b>cod</b> for "Cash On Delivery"<br>
                3. <b>cc</b> for "Credit Card"
                </p> -->
                    ...
                    <table id="gridTable" class="table table-striped m-table">
                        <thead>
                            <tr class="p-0 ">
                                ...
                                <th class="py-3">Order Date & Time</th>
                                <th class="py-3">Customer Type</th>
                                <th class="py-3">Customer Name</th>
                                <th class="py-3">Mobile/Phone</th>
                                <!-- <th class="py-3">Email</th> -->
                                <!-- <th class="py-3">Country</th> -->
                                <th width="10%" class="py-3">Paid Amount (AED)</th>
                                <th width="10%" class="py-3">Paid Amount (USD)</th>
