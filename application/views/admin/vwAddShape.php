...
<div class="m-subheader ">
    <div class="d-flex align-items-center">
        ...
        <a href="<? echo base_url('admin/material') ?>" class="btn btn-success m-btn m-btn--icon">
            ...
            <div class="m-portlet__body pb-2">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input type="text" class="form-control input-lg m-input" value="" name="title" id="title" required data-msg-required="Please enter shape name.">
                    </div>
                </div>
