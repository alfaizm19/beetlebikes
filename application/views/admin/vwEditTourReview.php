...
<div class="d-flex align-items-center">
 ...
 <a href="<? echo base_url('admin/tour-reviews/'.$review->tour_id) ?>" class="btn btn-success m-btn m-btn--icon">
      ...
      <div class="form-group m-form__group row imageFile">
        ...
        <div class="col-lg-9 col-md-12 col-sm-12">
          <div class="cropoutterwrap">
            <input type="file" class="form-control validImage" name="review_image" id="review_image" data-image-crop="1" data-image-height="<? echo CLIENT_SIZE_HEIGHT; ?>" data-image-width="<? echo CLIENT_SIZE_WIDTH; ?>" data-caption="Image" data-image-path ="reviews/<?php echo $review->id.'/' ?>"  data-msg-required="Please upload image">
          </div>
        ...
        <div class="m-form__actions m-form__actions py-0 ">
          <div class="row">
            <div class="col-lg-9 ml-lg-auto">
              <input type="hidden" name="tourId" value="<?php echo $review->tour_id ?>">
              <button type="submit" name="Submit" id="Submit" value="Save" class="btn btn-success"><i class="fa fa-save"></i>
                Save
              </button>
              <a  class="btn btn-secondary" href="<? echo base_url('admin/tour-reviews/'.$review->tour_id); ?>"><i class="fa fa-times"></i> Cancel </a>
            </div>
          </div>
        </div>
      </div>
