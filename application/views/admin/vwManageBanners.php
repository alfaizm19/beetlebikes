<div class="m-subheader ">
  <div class="d-flex align-items-center">
    ...
    <a href="<?php echo base_url('admin/banner/create'); ?>" class="btn btn-success m-btn m-btn--icon text-capitalize"> <span> <i class="fa fa-plus-circle"></i><span></span>Add Banner</span> </a></div>
</div>
<div class="col-sm-12">
    ...
    <table id="gridTable" class="table table-striped m-table ">
      <thead>
        <tr class="p-0 ">
          ...
          <!-- <th width="15%" class="py-3">Banner Type</th> -->

          <th width="20%" class="text-center py-3" data-orderable="false">Banner Image</th>

          <!-- <th width="15%" class="text-center py-3" data-orderable="false">Banner Video</th> -->
...
<input type="hidden" name="message" value="Promo Banner has been updated successfully.">
<input type="hidden" name="data_table" value="banner">
