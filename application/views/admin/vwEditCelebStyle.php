    ...
    <div class="m-portlet__body pb-2">
      ...
      <div class="form-group m-form__group row">
        ...
        <div class="col-lg-4 col-md-9 col-sm-12">
          <input type="name" class="form-control input-lg m-input" id="title" name="title" value="<?= $celeb->title ?>" required data-msg-required="Please enter title.">
        </div>
      </div>
      ...
      <div class="form-group m-form__group row">
          ...
          <div class="col-lg-9 col-md-9 col-sm-12">
              <textarea name="description" cols="4" rows="4" id="description" class="form-control ckerequired description input-lg m-input" required data-msg-ckrequired="Please enter description." ><?= $celeb->description ?></textarea>
      ...
      <div class="form-group m-form__group row">
        ...
        <div class="col-lg-2 col-md-9 col-sm-12">
          <input type="name" class="form-control input-lg m-input" id="price_aed" name="price_aed"  value="<?= $celeb->price_aed ?>" required data-msg-required="Please enter price aed.">
        </div>
      </div>
      ...
      <div class="form-group m-form__group row">
        ...
        <div class="col-lg-2 col-md-9 col-sm-12">
          <input type="name" class="form-control input-lg m-input" id="price_usd" name="price_usd"  value="<?= $celeb->price_usd ?>" required data-msg-required="Please enter price usd.">
        </div>
      </div>

      <div class="form-group m-form__group row imageFile">
        <label class="col-form-label col-lg-3 col-sm-12" for="celeb_image">Celeb Image (409px W * 585px H) </label>
        <div class="col-lg-9 col-md-12 col-sm-12">
          <div class="cropoutterwrap">
            <input type="file" class="form-control validImage" name="celeb_image" id="celeb_image" data-image-crop="1" data-image-height="585" data-image-width="409" data-caption="Image" data-image-path ="celeb-image/" data-msg-required="Please upload image.">
          </div>
          <?php if ($celeb->celeb_image != ""): ?>
              <?php if (!empty($celeb->crop_celeb_image)): ?>
                <div class="w-25 mt-2">
                    <img class="w-100" src="<?php echo base_url($celeb->crop_celeb_image); ?>">
                </div>
              <?php else: ?>
                <div class="w-25 mt-2">
                    <img class="w-100" src="<?php echo base_url($celeb->celeb_image); ?>">
                </div>
              <?php endif ?>
          <?php endif; ?>
        </div>
      ...
      <div class="form-group m-form__group row imageFile">
        ...
        <div class="col-lg-9 col-md-12 col-sm-12">
          ...
          <?php if ($celeb->product_image != ""): ?>
              <?php if (!empty($celeb->crop_product_image)): ?>
                <div class="w-25 mt-2">
                    <img class="w-100" src="<?php echo base_url($celeb->crop_product_image); ?>">
                </div>
              <?php else: ?>
                <div class="w-25 mt-2">
                    <img class="w-100" src="<?php echo base_url($celeb->product_image); ?>">
                </div>
              <?php endif ?>
          <?php endif; ?>
        </div>
      ...
      <div class="form-group m-form__group row">
        ...
        <div class="col-lg-4 col-md-9 col-sm-12">
          <input type="name" class="form-control input-lg m-input" id="link" name="link"  value="<?= $celeb->link ?>" data-msg-required="Please enter link.">
        </div>
      </div>
      ...
      <div class="form-group m-form__group row">
          ...
          <div class="col-lg-4 col-md-9 col-sm-12">
              <select name="background" class="form-control " id="background" data-placeholder="Select background" required data-msg-required="Please select background." data-allow-clear="true">
                  ...
                  <option <?= $celeb->background == "white"? 'selected':''; ?> value="white">White</option>
                  <option <?= $celeb->background == "light_grey"? 'selected':''; ?> value="light_grey">Light Grey</option>
                  <option <?= $celeb->background == "peach"? 'selected':''; ?> value="peach">Peach</option>
              </select> 
              <div class="has-error"></div>
          </div>
      </div>
      ...
      <div class="form-group m-form__group row">
        ...
        <div class="col-sm-2">
          <input type="number" maxlength="2" minlength="1" pattern="[0-9]+" class="form-control w-50 m-input" id="display_order" name="display_order" value="<?= $celeb->display_order ?>">
        </div>
      </div>
