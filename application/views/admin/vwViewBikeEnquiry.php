<div class="m-subheader ">
  ...
  <a href="<? echo base_url('admin/bike_enquiry') ?>" class="btn btn-success m-btn m-btn--icon">
        ...
        <table class="table table-bordered tableformat">
            <thead>
                ...
                <tr>
                    ...
                    <th width="70%"><?php echo date('Y-m-d', strtotime($info->invoice_date)) ?></th>
                </tr>
                
                <tr>
                    <th width="30%">Model</th>
                    <th width="70%"><?php echo $info->model ?></th>
                </tr>
                <tr>
                    <th width="30%">Chassis No</th>
                    <th width="70%"><?php echo $info->chassis_no ?></th>
                </tr>
                <tr>
                    <th width="30%">City</th>
                ...
                <tr>
                    ...
                    <th width="70%"><?php echo $info->state ?></th>
                </tr>
                <tr>
                    <th width="30%">Date</th>
