  ...
  <form class="m-form m-form--fit m-form--label-align-right" action="<? echo current_url(); ?>" method="post" enctype="multipart/form-data" name="collections_form" id="collections_form" novalidate="novalidate">
    <div class="m-portlet__body pb-2">
      ...
      <div class="form-group m-form__group row">
        ...
        <div class="col-lg-4 col-md-9 col-sm-12">
            <input type="text" class="form-control input-lg m-input" id="collections" name="collections" required data-msg-required="Please enter collections name.">
        </div>
      </div>

      <div class="form-group m-form__group row Image">
          <label class="col-form-label col-lg-3 col-sm-12" for="image_path"> Image  (1920px W * 606px H)<span class="text-danger">*</span> </label>
          <div class="col-lg-9 col-md-12 col-sm-12">
              <div class="cropoutterwrap">
                  <input type="file" required  class="form-control validImage" name="image_path" id="image_path" data-image-crop="1" data-image-height="606" data-image-width="1920" data-caption="Image" data-image-path ="collection/" data-msg-required="Please upload image">
              </div>
          </div>
      </div>
