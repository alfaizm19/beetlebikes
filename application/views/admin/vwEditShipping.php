        ...
        <form class="m-form m-form--fit m-form--label-align-right" action="<?php echo current_url(); ?>" method="post" enctype="multipart/form-data" name="location_form" id="location_form" novalidate="novalidate">
            <div class="m-portlet__body pb-2">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <select name="country" class="form-control " id="country" data-placeholder="Select country" required="" data-msg-required="Please select country." data-allow-clear="true">
                            ...
                            ?>
                                <option <?= $shipping->country == $country->id? 'selected':''; ?> value="<?php echo $country->id ?>"><?php echo $country->nicename ?></option>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input type="text" class="form-control input-lg m-input" id="first_half_aed" name="first_half_aed"  value="<?php echo $shipping->first_half_aed ?>" required data-msg-required="Please enter first half aed.">
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input type="text" class="form-control input-lg m-input" id="first_half_usd" name="first_half_usd"  value="<?php echo $shipping->first_half_usd ?>" required data-msg-required="Please enter first half usd.">
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input type="text" class="form-control input-lg m-input" id="adnl_half_kg_aed" name="adnl_half_aed"  value="<?php echo $shipping->adnl_half_aed ?>" required data-msg-required="Please enter additional half kg.">
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input type="text" class="form-control input-lg m-input" id="adnl_half_kg_usd" name="adnl_half_usd"  value="<?php echo $shipping->adnl_half_usd ?>" required data-msg-required="Please enter additional half kg.">
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row" style="display: none;">
                    ...
                    <div class="col-sm-2">
                        <input type="number" maxlength="2" minlength="1" pattern="[0-9]+" class="form-control w-50 m-input" id="display_order" name="display_order" value="<?php echo !empty($shipping->display_order)? $shipping->display_order:'1' ?>">
                    </div>
                </div>
