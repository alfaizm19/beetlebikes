<div class="m-subheader ">
    <div class="d-flex align-items-center">
        ...
        <a href="<? echo base_url('admin/second_sub_category/create'); ?>" class="btn btn-success export m-btn m-btn--icon text-capitalize"> <span> <i class="fa fa-plus-circle"></i><span></span>Add 2nd Level Sub Category</span> </a>
      </div>
</div>
<div class="col-sm-12">
                    ...
                    <table id="gridTable" class="table table-striped m-table">
                        <thead>
                            <tr class="p-0 ">
                                ...
                                <th width="29%" class="py-3">Sub Category</th>
                                <th width="29%" class="py-3">Second Sub Category Name</th>
                                <?php if(DISPLAY_ORDER): ?>
...
<input type="hidden" name="message" value="Sub Category has been updated successfully.">
<input type="hidden" name="data_table" value="sub_category">
