<div class="m-subheader ">
    <div class="d-flex align-items-center">
        ...
        <a href="<? echo base_url('admin/main_category/create'); ?>" class="btn btn-success m-btn m-btn--icon text-capitalize"> <span> <i class="fa fa-plus-circle"></i><span></span>Add Category</span> </a></div>
</div>
<div class="col-sm-12">
                    ...
                    <table id="gridTable" class="table table-striped m-table ">
                        <thead>
                            <tr class="p-0 ">
                                ...
                                <th width="40%" class="py-3">Category Name</th>
                                <?php if(DISPLAY_ORDER): ?>
...
<input type="hidden" name="data_table" value="main_category_new">
