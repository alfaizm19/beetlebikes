    ...
    <div class="m-portlet m-portlet--primary m-portlet--head-solid-bg m-portlet--head-sm" data-portlet="true" id="m_portlet_tools_2">
        ...
        <form class="m-form m-form--fit m-form--label-align-right" action="<?php echo current_url(); ?>" method="post" enctype="multipart/form-data" name="product_form" id="product_form" novalidate="novalidate">
            <div class="m-portlet__body pb-2">
                ...
                <!-- <div class="form-group m-form__group row video_url_div">
                    <label class="col-form-label col-lg-3 col-sm-12" for="video_url">Video URL<span class="text-danger">*</span></label>
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input type="text" class="form-control input-lg m-input" id="video_url" name="video_url" value="" required data-msg-required="Please enter video URL.">
                    </div>
                </div> -->
                ...
                <div class="form-group m-form__group row Image">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                      <div class="cropoutterwrap">
                        <input type="text" class="form-control" name="title" id="title" data-msg-required="Please enter title" required value="<?php echo $product->title ?>">
                      </div>
                    </div>
                  </div>
                ...
                <div class="form-group m-form__group row Image">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                      <div class="cropoutterwrap">
                        <textarea type="text" class="form-control" name="description" id="description" data-msg-required="Please enter description" required><?php echo $product->description ?></textarea>
                      </div>
                    </div>
                </div>

                <div class="form-group m-form__group row Image">
                    <label class="col-form-label col-lg-3 col-sm-12" for=""> Image   (220px W * 220px H)<?php //echo PRODUCT_IMAGES; ?><span class="text-danger">*</span> </label> 
                    ...
                    <div class="m-form__actions m-form__actions py-0 ">
                        <div class="row">
                            <div class="col-lg-9 ml-lg-auto">
                                ...
                                <a  class="btn btn-secondary" href="<?php echo base_url('admin/product_showcase/index/' . $this->uri->segment(4) . ''); ?>"><i class="fa fa-times"></i> Cancel </a>
                            </div>
                        </div>
                    </div>
                </div>
