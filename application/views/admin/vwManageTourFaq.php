<div class="m-subheader ">
    <div class="d-flex align-items-center">
        ...
        <a style="margin-right: 20px;" href="<?php echo base_url('admin/tours/'); ?>" class="btn btn-success m-btn text-capitalize m-btn--icon"></span>Tours</span> </a>
        <a href="<?php echo base_url('admin/tour-faq/create/'.$tourId); ?>" class="btn btn-success m-btn m-btn--icon text-capitalize"> <span> <i class="fa fa-plus-circle"></i><span></span>Add FAQs</span> </a>
    </div>
</div>
<div class="col-sm-12">
        ...
        <?php if (DISPLAY_ORDER): ?>
                    ...
                    <table id="gridTable" class="table table-striped m-table ">
                        <thead>
                            <tr class="p-0 ">
                                ...
                                <th width="33%" class="py-3">Question</th>
                                <?php if (DISPLAY_ORDER): ?>
            ...
            <?php if (DISPLAY_ORDER): ?>
                <div class="m-portlet__foot m-portlet__foot--fit border-top-1 border-secondary">
                    ...
                    <input type="hidden" name="data_table" value="faqs">
