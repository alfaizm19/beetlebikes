...
<div class="m-subheader ">
    <div class="d-flex align-items-center">
        ...
        <a href="<? echo base_url('admin/attribute-value/'.hash('SHA256', $attrib->id)); ?>" class="btn btn-success m-btn m-btn--icon">
        ...
        <form class="m-form m-form--fit m-form--label-align-right" action="<? echo current_url(); ?>" method="post" enctype="multipart/form-data" name="user_form" id="user_form" novalidate="novalidate">
            <div class="m-portlet__body pb-2">
                ...
                <div class="form-group m-form__group row">
                    <label class="col-form-label col-lg-3 col-sm-12" for="colors">
                        Attribute Value <span class="text-danger">*</span>
                    </label>
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input type="text" class="form-control input-lg m-input" value="" name="attribute_value[]" id="attribute_value" required data-msg-required="Please enter attribute value">
                    </div>
                    <div class="col-lg-2 col-md-2">
                        <a href="javascript:void(0)" class="addAttribValue btn btn-success m-btn m-btn--icon">
                            <span> <i class="fa fa-plus"></i><span></span>Add</span>
                        </a>
                    </div>
                </div>

                <div id="appendAttribValue"></div>
                    ...
                    <div class="m-form__actions m-form__actions py-0 ">
                        <div class="row">
                            <div class="col-lg-9 ml-lg-auto">
                                ...
                                <a  class="btn btn-secondary" href="<? echo base_url('admin/attribute-value/'.hash('SHA256', $attrib->id)); ?>"><i class="fa fa-times"></i> Cancel </a>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    $(".addAttribValue").click(function(event) {
        $("#appendAttribValue").append(`

            <div class="append_div form-group m-form__group row">
                <label class="col-form-label col-lg-3 col-sm-12" for="attribute_value">
                    &nbsp;
                </label>
                <div class="col-lg-4 col-md-9 col-sm-12">
                    <input type="text" class="form-control input-lg m-input" value="" name="attribute_value[]" id="attribute_value" required data-msg-required="Please enter attribute value">
                ...
                <div class="col-lg-2 col-md-2">
                    <a href="javascript:void(0)" class="removeAttribValue btn btn-success m-btn m-btn--icon">
    ...
    $("#appendAttribValue").on('click', '.removeAttribValue', function(event) {
