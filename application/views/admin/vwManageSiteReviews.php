<div class="m-subheader ">
    <div class="d-flex align-items-center">
        ...
        <a href="<? echo base_url('admin/site-reviews/create'); ?>" class="btn btn-success m-btn m-btn--icon text-capitalize"> <span> <i class="fa fa-plus-circle"></i><span></span>Add Reviews</span> </a></div>
</div>
<div class="col-sm-12">
        ...
        <? if (DISPLAY_ORDER): ?>
                    ...
                    <table id="gridTable" class="table table-striped m-table ">
                        <thead>
                            <tr class="p-0 ">
                                ...
                                <th width="20%" class="py-3">Name</th>
								<th width="10%" class="py-3">Rating</th>
                                <? if (DISPLAY_ORDER): ?>
            ...
            <? if (DISPLAY_ORDER): ?>
                <div class="m-portlet__foot m-portlet__foot--fit border-top-1 border-secondary">
                    <input type="hidden" name="message" value="Reviews has been updated successfully.">
                    <input type="hidden" name="data_table" value="reviews">
