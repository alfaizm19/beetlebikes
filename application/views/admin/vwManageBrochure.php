...
<!--     <a href="<?php// echo base_url('admin/brochure/create'); ?>" class="btn btn-success m-btn m-btn--icon text-capitalize"> <span> <i class="fa fa-plus-circle"></i><span></span>Add Brochure</span> </a> -->
  </div>
</div>
<div class="col-sm-12">
    ...
    <table id="gridTable" class="table table-striped m-table ">
      <thead>
        <tr class="p-0 ">
          ...
          <th width="50%" class="py-3">Brochure</th>
...
<input type="hidden" name="message" value="Brochure has been updated successfully.">
<input type="hidden" name="data_table" value="brochure">
