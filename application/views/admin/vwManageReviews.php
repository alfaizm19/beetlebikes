<div class="m-subheader ">
    <div class="d-flex align-items-center">
        ...
        <a href="<? echo base_url('admin/product'); ?>" class="btn btn-success m-btn m-btn--icon text-capitalize"> </span>Product</span> </a></div>
</div>
<div class="col-sm-12">
        ...
        <? if (DISPLAY_ORDER): ?>
            ...
            <? if (DISPLAY_ORDER): ?>
                <div class="m-portlet__foot m-portlet__foot--fit border-top-1 border-secondary">
                    ...
                    <input type="hidden" name="data_table" value="product_reviews">
