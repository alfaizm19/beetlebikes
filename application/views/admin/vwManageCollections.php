...
<div class="d-flex align-items-center">
 ...
 <a href="<? echo base_url('admin/collections/create') ?>" class="btn btn-success m-btn m-btn--icon"></span>Add Collection</span></a></div>
</div>
                    ...
                    <table id="gridTable" class="table table-striped m-table">
                        <thead>
                            <tr class="p-0 ">
                                ...
                                <th width="29%" class="py-3">Collections</th>
                                <?php if(DISPLAY_ORDER): ?>
...
<input type="hidden" name="message" value="Collections has been updated successfully.">
<input type="hidden" name="data_table" value="collections">
