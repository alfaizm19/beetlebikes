    ...
    <table id="gridTable" class="table table-striped m-table ">
      <thead>
        <tr class="p-0 ">
          ...
          <th width="25%" class="py-3">Country</th>
          <!-- <th width="25%" class="text-center py-3">Nationality</th>
          <th width="20%" class="text-center py-3" data-orderable="false">Phone code</th> -->
