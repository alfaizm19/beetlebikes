    ...
    <table id="gridTable" class="table table-striped m-table ">
      <thead>
        <tr class="p-0 ">
          ...
          <th width="15%" class="py-3">Contact Number</th>
          <!-- <th width="15%" class="py-3">Country</th> -->
          <th width="15%" class="py-3">Received Date</th>
          <th class="text-center py-3" width="12.5%" data-orderable="false">View</th>
          <th class="text-center py-3" width="12.5%" data-orderable="false">Delete</th>
        </tr>
      </thead>
    </table>
  </div>
