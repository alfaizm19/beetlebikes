<div class="m-subheader ">
  <div class="d-flex align-items-center">
    ...
    <a href="<?php echo base_url('admin/collaboration-gallery/create/'.$this->uri->segment(3).''); ?>" class="btn btn-success m-btn m-btn--icon text-capitalize manageproject"> <span> <i class="fa fa-plus-circle"></i><span></span>Add Collaboration Image </span> </a>
    <a href="<?php echo base_url('admin/collaborations'); ?>" class="btn btn-success  m-btn m-btn--icon text-capitalize"> <span> Collaborations</span> </a>
  </div>
</div>
