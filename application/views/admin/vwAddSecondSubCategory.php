  ...
  <form class="m-form m-form--fit m-form--label-align-right" action="<? echo current_url(); ?>" method="post" enctype="multipart/form-data" name="category_form" id="category_form" novalidate="novalidate">
    <div class="m-portlet__body pb-2">
      ...
      <!-- <div class="form-group m-form__group row">
        <label class="col-form-label col-lg-3 col-sm-12" for="sub_category_id">Sub Category<span class="text-danger">*</span>
        </label>
        <div class="col-lg-4 col-md-9 col-sm-12">
          <select name="sub_category_id" class="form-control m-select m_select_select " id="sub_category_id" data-placeholder="Select class" required data-msg-required="Please select class." data-allow-clear="true" >
          <option value=""<?php echo set_select('id','',TRUE); ?>>Select Category</option>
          <?php
          foreach ($categories as $key => $category) {
            ?>
            <option  value="<?php echo $category->id ?>" <?php echo set_select('id',$category->id); ?>><?php echo $category->sub_category_name;	 ?></option>
          <?php
          }
          ?>
</select>
      ...
      <div class="form-group m-form__group row">
        ...
        <div class="col-lg-4 col-md-9 col-sm-12">
            <input type="text" class="form-control input-lg m-input" id="second_sub_category_name" name="second_sub_category_name" value="<? echo get_input('second_sub_category_name'); ?>" required data-msg-required="Please enter category name.">
        </div>
      </div>
	  <!--/*Start :: Meta Title code here */-->
                <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-12">
                            <input type="text" class="form-control input-lg m-input" value="<? echo get_input('meta_title'); ?>" name="meta_title" id="meta_title" required data-msg-required="Please enter meta title.">
                        </div>
                    </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-6 col-md-9 col-sm-8">
                        <textarea name="meta_keyword" id="meta_keyword" data-msg-required="Please enter  meta keyword" class="form-control   input-lg m-input" rows="8"><? echo get_input('meta_keyword'); ?></textarea>
                        <div class="has-error"></div>
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-6 col-md-9 col-sm-12">
                        <textarea name="meta_description" id="meta_description" data-msg-required="Please enter meta description" class="form-control   input-lg m-input" rows="8"><? echo get_input('meta_description'); ?></textarea>
                        <div class="has-error"></div>
                    </div>
                </div>
