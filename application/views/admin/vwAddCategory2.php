      ...
      <form class="m-form m-form--fit m-form--label-align-right" action="<? echo current_url(); ?>" method="post" enctype="multipart/form-data" name="category_form" id="category_form" novalidate="novalidate">
        <div class="m-portlet__body pb-2">
          ...
          <div class="form-group m-form__group row">
            <label class="col-form-label col-lg-3 col-sm-12" for="category"> Parent<span class="text-danger">*</span></label>
            <div class="col-lg-4 col-md-9 col-sm-12">
              <select name="parent" class="form-control" id="parent" required data-msg-required="Please select parent category">
                <?php 
                  if (!empty($parentCategories)):
                    foreach($parentCategories as $parentCat):
                ?>
                  <option value="<?php echo $parentCat->id ?>"><?php echo $parentCat->category ?></option>
                <?php endforeach; else: ?>
	    ...
	    <label class="col-form-label col-lg-3 col-sm-12" for="image_path"> Image (1920px W * 350px H)<span class="text-danger">*</span> </label>
            <div class="col-lg-9 col-md-12 col-sm-12">
                <div class="cropoutterwrap">
                    <input type="file" required  class="form-control validImage" name="image_path" id="image_path" data-image-crop="0" data-image-height="350" data-image-width="1920" data-caption="Image" data-image-path ="category2/" data-msg-required="Please upload image">
                </div>
            </div>
          </div>
        ...
        <div class="form-group m-form__group row Image">
            <label class="col-form-label col-lg-3 col-sm-12" for="category_image"> Category Image (500px W * 500px H)<span class="text-danger">*</span> </label>
            <div class="col-lg-9 col-md-12 col-sm-12">
                <div class="cropoutterwrap">
                    <input type="file" required class="form-control validImage" name="category_image" id="category_image" data-image-crop="1" data-image-height="500" data-image-width="500" data-caption="Image" data-image-path ="category2/image/" data-msg-required="Please upload image">
                </div>
            </div>
          </div>
