            ...
            <div class="m-portlet__body pb-2">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input maxlength="40" type="text" class="form-control input-lg m-input" value="<?php echo $promo->promo_title ?>" name="promoTitle" id="promoTitle" required data-msg-required="Please enter promo title.">
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <select class="form-control input-lg m-input" name="category" id="category" data-msg-required="Please select category">
                            ...
                            ?>
                                <option <?php echo $promo->category == $cat->id? 'selected':'';  ?> value="<?php echo $cat->id ?>">
                        ...
                        <select name="sub_category[]" class="form-control m-select2 m_select2_select " multiple="multiple" id="sub_category" data-placeholder="Select sub category" data-msg-required="Please select sub category." data-allow-clear="true" >
                            <?php 
                                if (!empty($sub_category)): 
                                    ...
                                    $selSubCat = $promo->sub_category;

                                    $selSubCat = explode(',', $selSubCat);

                                    foreach($sub_category as $scat):

                            ?>
                                <option <?php echo in_array($scat->id, $selSubCat)? 'selected':''; ?> value="<?php echo $scat->id ?>"><?php echo $scat->category ?></option>
                            <?php endforeach; endif; ?>
                        </select> 
                        ...
                        <select name="exclusion_sub_category[]" class="form-control m-select2 m_select2_select " multiple="multiple" id="exclusion_sub_category" data-placeholder="Select sub category" data-msg-required="Please select sub category." data-allow-clear="true" >
                            <?php 
                                if (!empty($sub_category)): 
                                    ...
                                    $selExSubCat = $promo->exclusion_sub_category;

                                    $selExSubCat = explode(',', $selExSubCat);

                                    foreach($sub_category as $scat):

                            ?>
                                <option <?php echo in_array($scat->id, $selExSubCat)? 'selected':''; ?> value="<?php echo $scat->id ?>"><?php echo $scat->category ?></option>
                            <?php endforeach; endif; ?>
                        </select> 
                        <div class="has-error"></div>
                    </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <select class="form-control input-lg m-input" required name="usage" id="usage" data-msg-required="Please select usage">
                            <option <?php echo $promo->usage_time == 'single'? 'selected':''; ?> value="single">One Time</option>
                            <option <?php echo $promo->usage_time == 'multiple'? 'selected':''; ?> value="multiple">Multiple</option>
                        </select>
                    </div>
                </div>

                <div class="form-group m-form__group row max_used_div" style="<?php echo $promo->usage_time == 'multiple'? '':'display: none'; ?>">
                    <label class="col-form-label col-lg-3 col-sm-12" for="max_used">
                        Max Used <span class="text-danger">*</span>
                    </label>
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input type="text" id="max_used" class="form-control input-lg m-input" value="<?php echo $promo->multi_time_value ?>" name="max_used" id="max_used" data-msg-required="Please enter max used">
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <select class="form-control input-lg m-input" name="discountType" id="discountType" required data-msg-required="Please select discount type.">
                            <option <?php echo $promo->discount_type==1? 'selected':'' ?> value="1">Percentage</option>
                            <option <?php echo $promo->discount_type==2? 'selected':'' ?> value="2">Flat</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input pattern="^[a-zA-Z0-9]+$" minlength="3" required maxlength="8" type="text" class="form-control input-lg m-input" value="<?php echo $promo->promo_code ?>" name="code" id="code" data-msg-required="Please enter promo code">
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input type="date" min="1" class="form-control input-lg m-input" value="<?php echo $promo->start_date ?>" name="startDate" id="startDate" data-msg-required="Please enter start date">
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input type="date" min="1" class="form-control input-lg m-input" value="<?php echo $promo->end_date ?>" name="endDate" id="endDate" data-msg-required="Please enter end date">
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input type="number" required class="form-control input-lg m-input" value="<?php echo $promo->discount ?>" name="discount" id="discount" data-msg-required="Please enter discount">
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input type="number" class="form-control input-lg m-input" value="<?php echo $promo->min_cart_value ?>" name="min_cart_value" id="min_cart_value" data-msg-required="Please enter minimum cart value">
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input type="number" class="form-control input-lg m-input" value="<?php echo $promo->max_discount ?>" name="max_discount" id="max_discount" data-msg-required="Please enter maximum discount">
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input type="number" required class="form-control input-lg m-input" value="<?php echo $promo->stock ?>" name="stock" id="stock" data-msg-required="Please enter stock">
                    </div>
                </div>
