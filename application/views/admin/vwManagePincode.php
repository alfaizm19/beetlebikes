<div class="m-subheader ">
    <div class="d-flex align-items-center">
        ...
        <a style="margin-right: 5px;" href="<?php echo base_url('admin/pincode/export'); ?>" class="btn btn-success m-btn m-btn--icon text-capitalize"> <span> <i class="fa fa-print"></i><span></span>Export Pincode</span></a>

        <a href="<?php echo base_url('admin/pincode/create'); ?>" class="btn btn-success m-btn m-btn--icon text-capitalize"> <span> <i class="fa fa-plus-circle"></i><span></span>Add Pincode</span> </a>
      </div>
</div>
<div class="col-sm-12">
                ...
                <table id="gridTable" class="table table-striped m-table ">
                    <thead>
                        <tr class="p-0 ">
                            ...
                            <th width="15%" class="py-3">Pincode</th>
                            <th width="15%" class="py-3">State</th>              
                            <th width="15%" class="py-3">City</th>
