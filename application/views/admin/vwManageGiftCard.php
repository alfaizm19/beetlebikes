<div class="m-subheader ">
  <div class="d-flex align-items-center">
    ...
    <a href="<? echo base_url('admin/gift-card/create'); ?>" class="btn btn-success m-btn m-btn--icon text-capitalize"> <span> <i class="fa fa-plus-circle"></i><span></span>Add Gift Card</span> </a></div>
</div>
<div class="col-sm-12">
    ...
    <table id="gridTable" class="table table-striped m-table ">
      <thead>
        <tr class="p-0 ">
          ...
          <th width="15%" class="py-3">Receiver Name</th>
          <th width="15%" class="py-3">Receiver Email</th>
...
<input type="hidden" name="message" value="Gift card has been updated successfully.">
