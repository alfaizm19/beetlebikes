<div class="m-subheader ">
  <div class="d-flex align-items-center">
    ...
    <a href="<? echo base_url('admin/blog/create'); ?>" class="btn btn-success m-btn m-btn--icon text-capitalize"> <span> <i class="fa fa-plus-circle"></i><span></span>Add Blog</span> </a></div>
</div>
<div class="col-sm-12">
    ...
    <table id="gridTable" class="table table-striped m-table ">
      <thead>
        <tr class="p-0 ">
          ...
          <th width="20%" class="py-3">Title</th>
          <th width="20%" class="py-3">Category</th>
          <th width="13%" class="text-center py-3">Image</th>
          <!-- <th width="15%" class="text-center py-3">Blog Media</th> -->
          <th width="15%" class="text-center py-3">Comment</th>
