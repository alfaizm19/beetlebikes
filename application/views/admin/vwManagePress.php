<div class="m-subheader ">
    <div class="d-flex align-items-center">
        ...
        <a href="<?php echo base_url('admin/press/create'); ?>" class="btn btn-success m-btn m-btn--icon text-capitalize"> <span> <i class="fa fa-plus-circle"></i><span></span>Add Press</span> </a>
      </div>
</div>
<div class="col-sm-12">
        ...
        <?php if (DISPLAY_ORDER): ?>
                    ...
                    <table id="gridTable" class="table table-striped m-table ">
                        <thead>
                            <tr class="p-0 ">
                                ...
                                <th width="10%" class="py-3">Press Name</th>
                                <th width="10%" class="py-3">Title</th>
                                <th width="8%" class="text-center py-3">Image</th>
                                <?php if (DISPLAY_ORDER): ?>
            ...
            <?php if (DISPLAY_ORDER): ?>
                <div class="m-portlet__foot m-portlet__foot--fit border-top-1 border-secondary">
                    <input type="hidden" name="message" value="Press has been updated successfully.">
                    <input type="hidden" name="data_table" value="press">
