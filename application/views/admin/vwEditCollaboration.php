            ...
            <div class="m-portlet__body pb-2">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input type="text" class="form-control input-lg m-input" value="<?php echo $collab->title ?>" name="title" id="title" required data-msg-required="Please enter title.">
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12">
                        <textarea name="description" id="description" required data-msg-ckrequired="Please enter description." class="form-control ckerequired description input-lg m-input" rows="4"><?php echo $collab->description ?></textarea>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12">
                        <div class="cropoutterwrap">
                            <input type="file" class="form-control validImage" name="collabBanner" id="collabBanner" data-image-crop="1"  
                            data-image-height="985" data-image-width="2560" 
                            data-caption="Collaboration Banner" 
                                   data-image-path ="collaboration/" data-msg-required="Please upload collaboration banner">
                        </div>
                        <? if ($collab->banner != ""): ?>
                            <?php if (!empty($collab->crop_banner)): ?>
                                <div class="w-25 mt-2">
                                    <img class="w-100" src="<? echo base_url($collab->crop_banner); ?>">
                                </div>
                            <?php else: ?>
                                <div class="w-25 mt-2">
                                    <img class="w-100" src="<? echo base_url($collab->banner); ?>">
                                </div>
                            <?php endif; ?>
                        <? endif; ?>
                    </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12">
                        ...
                        <? if ($collab->video_background_image != ""): ?>
                            <div class="w-25 mt-2">
                                <img class="w-100" src="<? echo base_url($collab->video_background_image); ?>">
                            </div>
                        <? endif; ?>
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <textarea class="form-control input-lg m-input" value="" name="video" id="video" data-msg-required="Please enter video."><?php echo $collab->video ?></textarea>
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input type="text" class="form-control input-lg m-input" value="<?php echo $collab->meta_title ?>" required data-msg-required="Please enter meta title." name="meta_title" id="meta_title">
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <textarea name="meta_keyword" id="meta_keyword" class="form-control input-lg m-input" rows="3"><?php echo $collab->meta_keyword ?></textarea>
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <textarea name="meta_description" id="meta_description" class="form-control input-lg m-input" rows="3" ><?php echo $collab->meta_description ?></textarea>
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-sm-2">
                        <input type="number" min="1" maxlength="2" minlength="1" pattern="[0-9]+" class="form-control w-50 m-input" id="display_order" name="display_order" value="<?php echo $collab->display_order ?>">
                    </div>
                </div>
