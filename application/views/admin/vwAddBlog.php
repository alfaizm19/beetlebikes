                ...
                <div class="m-portlet__body pb-2">
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-12">
                            ...
                            value="<? echo ( isset($fieldValue['blog_title']) && !empty($fieldValue['blog_title']) )? $fieldValue['blog_title']:get_input('blog_title',$this->session->userdata('blog_title')); ?>" requireds>
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-12">
                            ...
                            value="<? echo ( isset($fieldValue['blog_link']) && !empty($fieldValue['blog_link']) )? $fieldValue['blog_link']:get_input('blog_link',$this->session->userdata('blog_link')); ?>"
                            requireds
                            >
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-12">
                            ...
                            value="<? echo ( isset($fieldValue['author_name']) && !empty($fieldValue['author_name']) )? $fieldValue['author_name']:get_input('author_name',$this->session->userdata('author_name')); ?>"
                            requireds
                            >
                    ...
                    <div class="form-group  m-form__group row">
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-12">
                            <div class="input-group date display_date w-50">
                                ...
                                readonly=""
                                value="<? echo ( isset($fieldValue['display_date']) && !empty($fieldValue['display_date']) )? $fieldValue['display_date']:get_input('display_date',$this->session->userdata('display_date')); ?>" requireds 
                                >
                    ...
                    <div class="form-group m-form__group row Image">
                        ...
                        <div class="col-lg-9 col-md-12 col-sm-12">
                            <div class="cropoutterwrap">
                                <input type="file" class="form-control validImage" name="image_path" id="image_path" data-image-crop="0" data-image-height="654" data-image-width="945" data-caption="Image" data-image-path ="blog/" data-msg-required="Please upload image" requireds>
