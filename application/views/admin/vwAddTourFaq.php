...
<div class="m-subheader ">
    <div class="d-flex align-items-center">
        ...
        <a href="<?php echo base_url('admin/tour-faq/'.$tourId) ?>" class="btn btn-success m-btn m-btn--icon">
                    ...
                    <div class="m-form__actions m-form__actions py-0 ">
                        <div class="row">
                            <div class="col-lg-9 ml-lg-auto">
                                ...
                                <a  class="btn btn-secondary" href="<?php echo base_url('admin/tour-faq/'.$tourId); ?>"><i class="fa fa-times"></i> Cancel </a>
                            </div>
                        </div>
                    </div>
                </div>
