<div class="m-subheader ">
  <div class="d-flex align-items-center">
    <div class="mr-auto">
      ...
      <a style="margin-right: 10px;" href="<? echo base_url('admin/attribute'); ?>" class="btn btn-success m-btn m-btn--icon text-capitalize"> <span> <i class="fa fa-arrow-left"></i><span></span>Back</span> </a>

      <a href="<? echo base_url('admin/attribute-value/create/'.hash('SHA256', $attrib->id)); ?>" class="btn btn-success m-btn m-btn--icon text-capitalize"> <span> <i class="fa fa-plus-circle"></i><span></span>Add Attribute Value</span> </a>
    </div>
  </div>
  <div class="col-sm-12">
