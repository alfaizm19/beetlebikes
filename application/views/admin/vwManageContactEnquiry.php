...
<div class="col-sm-12">
    ...
    <div class="col-md-4">
            <div class="row">
                <div class="col-md-1">
                    ...
                    ?>
                    <a id="exportBtn" href="<?php echo base_url('admin/contact_enquiry/createxls'.$buildQuery); ?>" class="btn btn-primary"><i class="fa fa-file-excel-o"></i> Export</a>
                </div>
            </div>
    </div>
    <!-- <div class="col-md-3">
    ...
    <div class="col-md-12 btns">
        ...
        <a class="btn btn-warning" href="<?php echo base_url('admin/contact_enquiry') ?>" style="color: white">Reset</a>
