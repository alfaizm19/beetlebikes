<div class="m-subheader ">
    <div class="d-flex align-items-center">
        ...
        <a href="<?php echo base_url('admin/shipping/create/'); ?>" class="btn btn-success m-btn m-btn--icon text-capitalize"> <span> <i class="fa fa-plus-circle"></i><span></span>Add Shipping</span> </a>
    </div>
</div>
<div class="col-sm-12">
        ...
        <?php if (!DISPLAY_ORDER): ?>
                    ...
                    <table id="gridTable" class="table table-striped m-table ">
                        <thead>
                            <tr class="p-0 ">
                                ...
                                <th width="10%" class="py-3">First Half (AED)</th>
                                <th width="10%" class="py-3">First Half (USD)</th>
                                <th width="10%" class="py-3">Add Half (AED)</th>
                                <th width="10%" class="py-3">Add Half (USD)</th>
                                <?php if (!DISPLAY_ORDER): ?>
            ...
            <?php if (!DISPLAY_ORDER): ?>
                <div class="m-portlet__foot m-portlet__foot--fit border-top-1 border-secondary">
                    <input type="hidden" name="message" value="Faq has been updated successfully.">
                    <input type="hidden" name="data_table" value="site_faqs">
