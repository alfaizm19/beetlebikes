      ...
      <div class="clearfix d-flex d-lg-block justify-content-between">
        ...
        <div class="pull-xs-left">
          <?php 
            if ($prod->stock):
          ?>
            <button id="btn_<?php echo $prodID; ?>" onclick="addToCart('<?php echo $prodID ?>')" class="prefix-sm-30 btn btn-default btn-icon btn-icon-left btn-w-180" type="button"><span class="icon icon fl-line-icon-set-grocery10"></span> Add to cart</button>
    ...
    <div class="col-12" id="comments">
      <div class="tabs-custom tabs-horizontal tabs-corporate" id="tabs-1">
        ...
        <ul class="nav nav-tabs">
          <li class="nav-item" role="presentation"><a class="nav-link active" href="#tabs-1-0" data-toggle="tab">Product Specs</a></li>
          <li class="nav-item" role="presentation"><a class="nav-link" href="#tabs-1-1" data-toggle="tab">Description</a></li>
                    ...
                    <div class="col-12">
                        <ul class="row">
                          ...
                          <div class="row">
                            ...
                            <li class="col-xs-12 col-md-6 list_0" >
                            <div class="row">
                            <p class="col-xs-6 col-sm-6 col-md-6 mt-1 font-weight-bold">Net Weight (gm)</p><p class="col-xs-6 col-sm-6 col-md-6  mt-1"><?php echo $prod->net_weight ?></p>
                            </div>
                            </li>
                            <li class="col-xs-12 col-md-6 list_0" >
                            <div class="row">
              ...
              <div class="tab-review">
               <!-- <div class="tab-review-media"><img alt="" src="<? //echo HTTP_ASSETS_PATH_CLIENT; ?>images/product-06.jpg" width="97" height="97"></div>-->
                <div class="tab-review-body offset-top-10">
                  <p>Posted by <a href='blog-list.html'>Shane Doe</a>  </p>
                  <p style="font-weight:600"><div class="product-details-rating mr-2" style="display: inline-block;"><span class="icon icon-xs mdi mdi-star"></span><span class="icon icon-xs mdi mdi-star"></span><span class="icon icon-xs mdi mdi-star"></span><span class="icon icon-xs mdi mdi-star"></span><span class="icon icon-xs mdi mdi-star text-gray-light"></span></div>Sturdy and value for money</p>
                  <p>&#34;Thanks a lot for the quick response. I was really impressed, your solution is excellent!! Your competence is justified!!!&#34;</p>
                  
                  <a class="" href="<?php echo base_url($prod->image_path) ?>" data-lightgallery="item" tabindex="0">
                    <img src="<?php echo base_url($prod->image_path) ?>" width="50" class="pull-left mr-2 mt-1 img-thumbnail"/>
                  </a>
