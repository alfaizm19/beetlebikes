		...
		<div class="container px-0">
			...
			<div class="row">
				<div class="col-md-12 text-center">
					<button data-limit="<?php echo $limit ?>" data-total="<?php echo $total ?>" data-offset="<?php echo $limit ?>" data-slug="<?php echo $slug ?>" class="load_product load_more_product_wcoll">Load more products</button>
				</div>
			</div>
			<?php endif ?>
		</div>
