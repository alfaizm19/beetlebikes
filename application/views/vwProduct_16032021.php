               ...
               <div class="col-md-6 pro_left">
                  <div class="d-flex align-items-center">
                     ...
                     <div class="tab-content" id="v-pills-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="v-pills-home-main-image" role="tabpanel" aria-labelledby="v-pills-home-tab-main-image">
                           <div class="text-center">
                              <img src="<?php echo base_url($prod->image_path) ?>" style="max-width: 380px;">
                           </div>
                        </div>

                        <div class="tab-pane fade" id="v-pills-home-roll-image" role="tabpanel" aria-labelledby="v-pills-home-tab-roll-image">
                           <div class="text-center">
                              <img src="<?php echo base_url($prod->roll_image) ?>" style="max-width: 380px;">
                           </div>
                        </div>

                        <?php $i=1; foreach ($images as $img): ?>
                        <div class="tab-pane fade" id="v-pills-home<?= $i ?>" role="tabpanel" aria-labelledby="v-pills-home-tab<?= $i ?>">
                           <div class="text-center">
                              <img src="<?php echo base_url($img->image_path) ?>" style="max-width: 380px;">
                           </div>
                        </div>
                        <?php $i++; endforeach ?>
                     </div>
                     <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        ...
                        <a class="nav-link active" id="v-pills-home-tab-main-image" data-bs-toggle="pill" href="#v-pills-home-main-image" role="tab" aria-controls="v-pills-home" aria-selected="true"><img src="<?php echo base_url($prod->image_path) ?>"></a>

                        <a class="nav-link" id="v-pills-home-tab-roll-image" data-bs-toggle="pill" href="#v-pills-home-roll-image" role="tab" aria-controls="v-pills-home" aria-selected="true"><img src="<?php echo base_url($prod->roll_image) ?>"></a>

                        <?php $i=1; foreach ($images as $img): ?>
                        <a class="nav-link" id="v-pills-home-tab<?= $i ?>" data-bs-toggle="pill" href="#v-pills-home<?= $i ?>" role="tab" aria-controls="v-pills-home" aria-selected="true"><img src="<?php echo base_url($img->image_path) ?>"></a>
                        <?php $i++; endforeach; ?>
                     </div>
                     <?php else: ?>
                        <div class="tab-content" id="v-pills-tabContent">
                        ...
                        <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                           <a class="nav-link active" id="v-pills-home-tab" data-bs-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true"><img src="<?php echo base_url($prod->image_path) ?>"></a>
                           <a class="nav-link" id="v-pills-profile-tab" data-bs-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false"><img src="<?php echo base_url($prod->roll_image) ?>"></a>
                        </div>
                     <?php endif ?>
                  </div>
               </div>
