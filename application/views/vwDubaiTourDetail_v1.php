        ...
        <div class="col-md-4 col-lg-4 col-xl-4">
          ...
          <ul class="tour-features rounded">
            ...
            <li class="fa fa-car-pick">Pick Up & Drop: 
              <strong><?php echo ucwords($tour->pickup) ?></strong>
				...
				<div class="offset-xl-auto offset-lg-auto col-md-4 col-lg-3 col-sm-12 display-a-c">
          <div class="page-price-wrap font_karla font-weight-700 price_sec">
            <span class="d-inline-block">
              ...
              <?php if ($discount>0): ?>
				<del>AED <?php echo $price ?></del></span>
              <?php endif ?>
              <span class="d-flex">
				  <span class="font-24">Price</span>
				  <span class="font-38">AED 
        ...
        <div class="row">
          ...
          <?php 
            foreach ($tourOptions as $tourOption):
              ...
              $discount = 0;
              if ($tourOption->discount > 0) {
                $discount = ($tourOption->adult_aed * $tourOption->discount)/100;
              }
          ?>
          <div class="col-lg-7 col-md-7 col-sm-7">
            <div class="row">
              ...
              <div class="col-md-4 col-sm-4">
                <div class="page-price-wrap font_karla font-weight-700 text-center">
                  <span class="d-inline-block text-white font-30">
                    <?php if ($discount>0): ?>
                      <del class="showDis_<?php echo $tourOption->id ?>">AED <?php echo $price ?></del>
                    <?php endif ?>
                    <span class="font-30 showPrice_<?php echo $tourOption->id ?>">
                      AED <?php echo $discount>0? $price-$discount:$price; ?>
                    </span>
                  </span>
                </div>
              </div>
...
<button type="submit" class="site-button btn-lg font-22-i font-weight-700 font_karla" id="addCartTour">Add to Cart</button>
...
<div class="p-a20">
  ...
  <?php endif ?>
    ...
    <div class="row justify-content-center justify-items-center">
      ...
      <div class="col-md-12 m-b20">
        <select class='zcwf_col_fld_slt' id='LEADCF28' name='LEADCF28' class="bs-select-hidden m-b30">
      ...
      <div class="col-md-12 m-b20">
        <div class="input-group font-20 font_karla">
          <input type='text' id='LEADCF27' name='LEADCF27' maxlength='255' class="form-control font-20-i font_karla_i" placeholder="Travel Date"></input>
        </div>
      </div>
      <div class="col-md-12 m-b20">
        <div class="input-group">
          <textarea id='Description' name='Description' rows="4" class="form-control font-20-i font_karla_i" placeholder="Message*"></textarea>
        </div>
      </div>
      ...
      <div class="col-md-12">
        <div class="detail-page-block">
          <div class="dlab-accordion box-sort-in m-b30 no-gap" id="accordion0016">
            ...
            <div class="panel">
              <div class="acod-head">
                <h6 class="acod-title"><a href="javascript:void(0);" data-toggle="collapse" aria-expanded="true" data-target="#collapse<?php echo $faq->id; ?>" class="<?php echo $i==1? 'collapsed':'' ?>"><?php echo $faq->question ?></a>
                </h6>
              </div>
              <div id="collapse<?php echo $faq->id; ?>" class="acod-body collapse show" data-parent="#accordion0016" style="">
