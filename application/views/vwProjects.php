           ...
           <? foreach ($projects as $key => $projects_val): ?>  
            <section class="col-lg-4">
              <aside class="industries-list">
                <figure class="figure-custom" data-toggle="modal" data-target="#productid2" data-id="<?=$key?>"><img src="<? echo base_url($projects_val['project_image_thumb']); ?>" alt="<? echo $projects_val['project_title']; ?>"><div class="border-cust"><span class="zoomicon"  data-id="<?=$key?>"></span></div></figure>
...
<section class="modal fade product-popup" id="productid2" role="dialog">
    <section class="modal-dialog modal-dialog-centered"> 
