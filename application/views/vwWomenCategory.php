<div class="breadcrumb_content">
	<h4>Women</h4>
	<p><a href="<?php echo base_url() ?>">Home</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;Women</p>
</div>
		...
		<div class="container px-0">
			...
			<div class="row">
				<div class="col-md-12 text-center">
					<button data-limit="<?php echo $limit ?>" data-total="<?php echo $total ?>" data-offset="<?php echo $limit ?>" data-slug="<?php echo $slug ?>" class="load_product load_more_product_wcat">Load more products</button>
				</div>
			</div>
			<?php endif ?>
