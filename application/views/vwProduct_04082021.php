  ...
  <div class="row product-details row-30">
    ...
    <div class="col-lg-6 text-md-left details">
      ...
      <p class="mt-3 font-italic">
        ...
        <a class="prefix-sm-30 link" href="javascript:void(0)" onclick="wishlist('<?php echo $prodID ?>')">
      ...
      <div class="clearfix d-flex d-lg-block justify-content-between">
        ...
        <div class="pull-xs-left">
          <?php 
            if ($prod->stock):
          ?>
            <button id="btn_<?php echo $prodID; ?>" onclick="addToCart('<?php echo $prodID ?>')" class="prefix-sm-30 btn btn-default btn-icon btn-icon-left btn-w-180 mb-2 rounded-btn" type="button"><span class="icon icon fl-line-icon-set-grocery10"></span> Add to cart</button>

            <button id="buy_now_btn_<?php echo $prodID; ?>" onclick="buyNow('<?php echo $prodID ?>')" class="prefix-sm-30 btn btn-primary btn-icon btn-icon-left btn-w-180 mb-2 rounded-btn" type="button"><span class="icon icon fl-line-icon-set-shopping63"></span> Buy Now</button>
