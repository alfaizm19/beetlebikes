            ...
            <table>
                <tr>
                    <td>
                        ...
                        <p>Your order #<?php echo strtoupper($orderInfo->custom_orderid) ?> has been cancelled due to unavoidable circumstances. We sincerely apologize for the inconvenience caused.<br><br>
                        We have initiated a refund of the amount paid to the source account. It should reflect in your source account with the next 5-7 business days.</p>
                    </td>
                </tr>
            </table>
            ...
            <table style="padding-left: 0;padding-right: 0;">
                <tr>
                    <td colspan="3" style="padding-bottom: 10px;">
                        ...
                        <hr>
                        <p class="plr10"><b>Order #</b>xxx-xxxxxxx-xxxxxxx</p>
                        <p class="plr10">Placed on Wednesday, January 24, 2018</p>
                    </td>
                </tr>
