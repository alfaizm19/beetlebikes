    ...
    <! View in Browser Link -->
        ...
        <div id="email">
            ...
            <table>
                <tr>
                    <td>
                        <p style="padding-bottom: 15px;">Need to make changes to your order? Reach out to us at <a href="mailto:support@beetlebikes.in" style="text-decoration: none;color: #2ba8db;">support@beetlebikes.in</a></p>
