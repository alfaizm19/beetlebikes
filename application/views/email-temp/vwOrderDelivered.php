    ...
    <! View in Browser Link -->
        ...
        <div id="email">
            ...
            <table>
                <tr>
                    <td>
                        ...
                        <p>We have succesfully delivered your (order id - <?php echo strtoupper($orderInfo->custom_orderid) ?>) on the given address with following item:</p>
                    </td>
                </tr>
            </table>  
            <table style="border-top: 2px solid #2ba8db;">
                <tr>
                    <td style="width: 50%;padding-left: 15px;">
                        ...
                        <a href="<?php echo base_url('login') ?>"><button style="cursor: pointer;" class="button">Delivered To:</button></a>
                    </td>
                    <td style="width: 50%;">
            ...
            <table style="padding-left: 0;padding-right: 0;">
                <tr>
                    <td colspan="3" style="padding-bottom: 10px;">
                        <h3 class="plr10" style="color: #2ba8db;">Package Contents</h3>
                        <hr>
            ...
            <table>
                <tr>
                    <td>
                        <p style="padding-bottom: 15px;">Do not forget to leave your a review of the product by following this link. <a href="<?php echo base_url('login') ?>" style="text-decoration: none;color: #2ba8db;">Review</a></p>
