...
<!-- Banner Start -->
<section class="swiper-container swiper-slider home-slider" data-slide-effect="fade" data-min-height="430px" data-autoplay="false">
...
<?php if (!empty($catLv1)): ?>
<section class="offset-top-45 section_banners-countdown ">
  <div class="container">
    <div class="row full_w_row">
      <?php foreach ($catLv1 as $cat): ?>
      	<div class="col-xs-12 col-sm-4 banner_item item_small border-unset">
    ...
    <div class="row full_w_row">
      <div class="col-sm-6 banner_big_50">
      	<div class="banner_item">
      		<div class="img_placeholder__wrap img_placeholder__medium" style="background-image: url( <? echo HTTP_ASSETS_PATH_CLIENT; ?>/images/top-product-1.jpg);"></div>
      ...
      <div class="col-sm-6 banner_big_50">
      	<div class="banner_item">
      		<div class="img_placeholder__wrap img_placeholder__medium" style="background-image: url( <? echo HTTP_ASSETS_PATH_CLIENT; ?>/images/top-product-2.jpg );"></div>
      		<div class="banner_caption position_bottom style_none">  
      			<div class="caption_text">
      				<h3>New Collection</h3>
      				<a class="btn banner_btn" href="/collections/gold">shop now</a>
  ...
  <div class="container">
    ...
    <div class="owl-mobile-dots owl-nav-md owl-nav-position-top owl-carousel offset-top-30" data-mouse-drag="false" data-autoplay="4000" data-lg-items="3" data-md-items="2" data-sm-items="2" data-margin="30" data-dots="true" data-nav="true">
      <div class="blog-post blog-post-grid">
        <div class="blog-post-media"><a href="single-blog-post.html"><img class="img-responsive" width="1170" height="854" alt="" src="images/index-17.jpg">
      ...
      <div class="blog-post blog-post-grid">
        <div class="blog-post-media"><a href="single-blog-post.html"><img class="img-responsive" width="1170" height="854" alt="" src="images/index-18.jpg">
            <div class="blog-post-caption">
      ...
      <div class="blog-post blog-post-grid">
        <div class="blog-post-media"><a href="single-blog-post.html"><img class="img-responsive" width="1170" height="854" alt="" src="images/index-19.jpg">
            <div class="blog-post-caption">
              <div class="blog-post-meta-date"><span class='blog-post-meta-date-big reveal-block'>26</span> APR</div>
            </div></a></div>
        <div class="blog-post-meta">
