      ...
      <div class="clearfix d-flex d-lg-block justify-content-between">
        ...
        <div class="pull-xs-left">
          ...
          ?>
            ...
            <button id="buy_now_btn_<?php echo $prodID; ?>" onclick="buyNow('<?php echo $prodID ?>')" class="prefix-sm-30 btn btn-default btn-icon btn-icon-left btn-w-180" type="button"><span class="icon icon fl-line-icon-set-shopping63"></span> Buy Now</button>
...
<div class="row">
<p class="col-xs-6 col-sm-6 col-md-6 mt-1 font-weight-bold">Gem Stone 1</p><p class="col-xs-6 col-sm-6 col-md-6  mt-1">Topaz|2|Prong|Trillion</p>
</div>
</li>
<li class="col-xs-12 col-md-6 list_0" >
<div class="row">
