            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="contact-message">
                        <h4>Leave Message</h4>
                        <form id="contact-form" action="<?php echo base_url('ajax/dealersEnquiry') ?>" method="post">
                            ...
                            <span class="text-danger removeErr subjectErr"></span>
                            ...
                            <span class="text-danger removeErr storeErr"></span>
                            <span class="text-danger removeErr cityErr pull-right"></span>
