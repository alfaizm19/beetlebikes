            ...
            <?php 
                if($allProducts) { 
                    foreach ($allProducts as $allProductsKey => $allProductsValue) {
                        ...
                        $label = $this->Master_model->getLabel($allProductsValue['id']);
            ?>
                ...
                <div class="single-product text-center">
                    <div class="single-product-inner">
                        ...
                        <div class="product-details">
                            <h3>
                                <a href="<?php echo base_url().'product/'.$allProductsValue['slug']; ?>"><?php echo $allProductsValue['product_name']; ?></a>
                            </h3>
                          <!--   <div class="revew">
                            ...
                            <div class="price-box">
                                ...
                                ?>
                                    <div class="old-price"><span><i class="fa fa-inr"></i><?php echo $allProductsValue['mrp'];?></span></div>
                                    <div class="new-price"><span><i class="fa fa-inr"></i><?php echo $allProductsValue['selling_price'];?></span></div>
                                <?php } else {    ?>
                                        <div class="new-price"><span><i class="fa fa-inr"></i><?php echo $allProductsValue['mrp'];?></span></div>
                                <?php } ?>    
                            </div>
                        </div>
                        ...
                        $getStock = $this->Master_model->getStock($allProductsValue['id']);
                    ?>
                    ...
                    */
                    ?>
                    <li><a  style="<?php echo $cart_product_remove; ?>" href="<?php echo base_url(); ?>cart" class="add_cart remove_cart_<?php echo $allProductsValue['id']; ?>" >Go To Cart</a></li>
                        ...
                        <div class="product-details">
                         ...
                         <!--    <div class="product-review">
                            ...
                            <div class="producut-desc">
                                <p><?php echo character_limiter($allProductsValue['specifications'], 250); ?></p>
                            </div>
