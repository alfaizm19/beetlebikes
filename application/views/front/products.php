                ...
                <div class="col-md-3 col-sm-4 col-xs-12">
                    ...
                    <div class="categoryies-option">
                        ...
                        <ul>
                            ...
                            <li>
                                <input class="catFilter" onclick="productSideFilter()" id="catFilter<?php echo $categoriesWithPrdouctCountValue['cat_id']; ?>" value="<?php echo $categoriesWithPrdouctCountValue['cat_id']; ?>" type="checkbox" name="categories[]" <?php if (isset($_GET['catId']) &&  $_GET['catId'] == $categoriesWithPrdouctCountValue['cat_id']) { echo "checked='checked'"; } ?>>
