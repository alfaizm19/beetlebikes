<section class="page-content">
    <figure style="position:relative;">
        <div class="shadow-mask">
				        <img src="<?php echo base_url($cat->banner_image) ?>" class="img-responsive" style="width:100%;height:100%;" />
				    </div>
        <div class="container p-0">
        <div class="row mt-0">
			<div class="col-12">
				<div class="row category-banner m-0" style="padding: 10% 0;">
			...
			<div class="col-lg-12 col-md-6">
				...
				<ul class="offset-top-20 list-dividers">
					<?php foreach ($child as $subCat): ?>
						<li><a href="<?php echo base_url($cat->slug.'/'.$subCat->slug) ?>"><?php echo $subCat->category ?></a></li>
					<?php endforeach ?>
				</ul>
		...
		<div class="col-lg-12 col-md-6 offset-top-45 offset-md-top-0">
			...
			<div class="offset-top-20">
				...
				<!-- <div class="form-group offset-top-10">
					...
					<input class="price" data-min="5000" data-max="" type="checkbox" name="price[]"> Less than ₹5000
				</div> -->
				...
				<?php if ($minMRP < 5000): ?>
					<div class="form-group offset-top-10">
						<input class="price" data-min="0" data-max="5000" type="checkbox" name="price[]"> Less than <i class="fa fa-inr"></i>5000
					</div>	
				<?php endif ?>
				
				<?php if ($maxMRP > 5000 && $minMRP < 10000): ?>
					<div class="form-group offset-top-10">
						<input class="price" data-min="5000" data-max="10000" type="checkbox" name="price[]"> Between <i class="fa fa-inr"></i>5000 and <i class="fa fa-inr"></i>10000
					</div>
				<?php endif ?>

				<?php if ($maxMRP > 10000 && $minMRP < 20000): ?>
					<div class="form-group offset-top-10">
						<input class="price" data-min="10000" data-max="20000" type="checkbox" name="price[]"> Between <i class="fa fa-inr"></i>10000 and <i class="fa fa-inr"></i>20000
					</div>
				<?php endif ?>
				
				<?php if ($maxMRP > 20000 && $minMRP < 30000): ?>
					<div class="form-group offset-top-10">
						<input class="price" data-min="20000" data-max="30000" type="checkbox" name="price[]"> Between <i class="fa fa-inr"></i>20000 and <i class="fa fa-inr"></i>30000
					</div>
				<?php endif ?>

				<?php if ($maxMRP > 30000 && $minMRP < 40000): ?>
					<div class="form-group offset-top-10">
						<input class="price" data-min="30000" data-max="40000" type="checkbox" name="price[]"> Between <i class="fa fa-inr"></i>30000 and <i class="fa fa-inr"></i>40000
					</div>
				<?php endif ?>

				<?php if ($maxMRP > 40000 && $minMRP < 50000): ?>
					<div class="form-group offset-top-10">
						<input class="price" data-min="40000" data-max="50000" type="checkbox" name="price[]"> Between <i class="fa fa-inr"></i>40000 and <i class="fa fa-inr"></i>50000
					</div>
				<?php endif ?>

				<?php if ($maxMRP > 50000): ?>
					<div class="form-group offset-top-10">
						<input class="price" data-min="50000" data-max="more" type="checkbox" name="price[]"> <i class="fa fa-inr"></i>50000 and more
					</div>
				<?php endif ?>
			</div>
		...
		<div class="row mt-1 appendProducts">
			...
			if (!empty($products)):
				foreach($products as $product):
					...
					$productSlug = base_url(category_slug_by_id($product->category_level_1).'/').$product->slug;
...
<script>
	$(window).scroll(function(){
	  if ($(window).scrollTop() == $(document).height()- $(window).height()) {
		...
		loadMoreProducts(total, limit, offset, parent, minPrice, maxPrice, sort, atttrib_name, atttrib_value);
	  }
	});

	function loadMoreProducts(total, limit, offset, parent, minPrice, maxPrice, sort, atttrib_name, atttrib_value) {
		
		if (total > offset) {
			$.ajax({
				url: base_url+"load_more/parent_cat_product",
				type: 'POST',
				dataType: 'json',
				data: {total: total, limit: limit, offset: offset, parent: parent, atttrib_name: atttrib_name, atttrib_value: atttrib_value, minPrice: minPrice, maxPrice: maxPrice, sort: sort},
				beforeSend: function () {
	...
	$('.attributes').on('change', function() {
        ...
        $.ajax({
        	url: base_url+'load_more/filter_sort_parent_cat_prod',
        	type: 'POST',
        	dataType: 'json',
        	data: {
        		parent: parent,
