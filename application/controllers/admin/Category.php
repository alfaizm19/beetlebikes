...
class Category extends Admin_Controller {
    ...
    public function index() {
        ...
        $this->data['manage_view_path'] = '' . base_url() . 'admin/category/view/';
        $this->render('admin/vwManageCategory');
    }

    public function view() {

        $perm = $this->Permission_model->checkPerm(get_admin_id(), 'category_level_1', 'read');
        ...
        $this->setPageTitle('Manage Product Categories');
        echo $list = $this->category->get_datatables();
    }
    ...
    public function create() {
        ...
        $this->render('admin/vwAddCategory');
    }

    public function save() {

        $perm = $this->Permission_model->checkPerm(get_admin_id(), 'category_level_1', 'create');

        if (!$perm) {
            set_flash('message', 'danger', 'You dont have permission');
            redirect('admin/category-level-1/', 'refresh');
            die();
        }
        ...
        $this->images->setAllowedTypes('image_path', 'jpg|jpeg|png')->setPath('image_path', './uploads/category/');
        ...
        if (!empty($_POST['crop_image_path'])) {
            ...
            $imageName = 'uploads/category/'.$imageName. '.png';
        ...
        $this->images->setAllowedTypes('category_image', 'jpg|jpeg|png')->setPath('category_image', './uploads/category/image/');
        ...
        if (!empty($_POST['crop_category_image'])) {
            ...
            $catImageName = 'uploads/category/image/'.$catImageName. '.png';
        ...
        if ($insert) {
            ...
            redirect('admin/category-level-1/', 'refresh'); //redirect in manage with msg
        }
        return FALSE;
    }
    ...
    public function edit($id = NULL) {
        ...
        $this->render('admin/vwEditCategory');
    }

    //Update one item
    public function update($id) {   

        $perm = $this->Permission_model->checkPerm(get_admin_id(), 'category_level_1', 'update');
        ...
        $this->images->setAllowedTypes('image_path', 'jpg|jpeg|png')->setPath('image_path', './uploads/category/')->setUnlink('image_path', $this->data['category']->banner_image);
        ...
        $this->images->setAllowedTypes('category_image', 'jpg|jpeg|png')->setPath('category_image', './uploads/category/image/')->setUnlink('category_image', $this->data['category']->category_image);
    ...
    public function delete() {
        if ($this->input->is_ajax_request()) {
            ...
            $perm = $this->Permission_model->checkPerm(get_admin_id(), 'category_level_1', 'delete');
            ...
            if (!$perm) {
                ...
                $isExist = $this->db->query("SELECT * FROM `product` WHERE category_level_1 IN (".$id.") ")->num_rows();
