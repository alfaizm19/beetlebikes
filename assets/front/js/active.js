...
(function($) {
   ...
   /*-------------------------------------------
    ...
    /*---------------------------
        02. Active hover function
    ----------------------------*/
        $('.currency li, .language li, .mini-cart').on("click", function() {
            $(this).find(".currency-menu, .language-menu, .cart-area").toggle(1000);
   ...
   $('#mainSlider').nivoSlider({
    ...
    $( "#price-slider" ).slider({
       range: true,
       min: parseInt(price_data.min),
       max: parseInt(price_data.max),
       values: [ parseInt(price_data.min), parseInt(price_data.max) ],
