...
$(".m-dropdown__toggle").click(function(){
 $(".m-dropdown__wrapper").slideToggle('slow');
});
$(".m-menu__toggle").click(function(){
//$(".m-menu__submenu").not(this).slideUp('slow');
	$(".m-menu__toggle").not(this).parents("li").removeClass("m-menu__item--open");
	
	$(this).parents("li").toggleClass("m-menu__item--open");
